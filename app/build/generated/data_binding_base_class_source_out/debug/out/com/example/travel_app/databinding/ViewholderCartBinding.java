...
public final class ViewholderCartBinding implements ViewBinding {
  ...
  private ViewholderCartBinding(@NonNull ConstraintLayout rootView, @NonNull TextView addressTxt,
  ...
  public static ViewholderCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewholderCartBinding((ConstraintLayout) rootView, addressTxt, imageView5,
