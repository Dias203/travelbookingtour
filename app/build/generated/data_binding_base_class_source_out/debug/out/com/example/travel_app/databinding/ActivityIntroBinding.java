...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  private ActivityIntroBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView introBtn,
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.introBtn;
      ImageView introBtn = ViewBindings.findChildViewById(rootView, id);
      if (introBtn == null) {
        break missingId;
      }
      ...
      return new ActivityIntroBinding((ConstraintLayout) rootView, introBtn, main, textView,
          textView2);
    }
