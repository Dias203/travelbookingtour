...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatImageView introBtn;
  ...
  private ActivityIntroBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView introBtn, @NonNull TextView textView,
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.introBtn;
      AppCompatImageView introBtn = ViewBindings.findChildViewById(rootView, id);
      if (introBtn == null) {
        break missingId;
      }
      ...
      return new ActivityIntroBinding((ConstraintLayout) rootView, introBtn, textView, textView2);
    }
