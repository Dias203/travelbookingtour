...
public final class ActivityAllTourBinding implements ViewBinding {
  ...
  private ActivityAllTourBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backBtn,
  ...
  public static ActivityAllTourBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAllTourBinding((ConstraintLayout) rootView, backBtn, main,
