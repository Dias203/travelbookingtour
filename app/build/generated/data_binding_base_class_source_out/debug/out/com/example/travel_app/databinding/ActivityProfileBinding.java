...
public final class ActivityProfileBinding implements ViewBinding {
  ...
  private ActivityProfileBinding(@NonNull ConstraintLayout rootView,
      @NonNull ChipNavigationBar bottomnav, @NonNull Button button, @NonNull ConstraintLayout main,
      @NonNull TextView textView11, @NonNull TextView textView5) {
  ...
  public static ActivityProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileBinding((ConstraintLayout) rootView, bottomnav, button, main,
