...
public final class ActivityForgotPasswordBinding implements ViewBinding {
  ...
  private ActivityForgotPasswordBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputEditText email, @NonNull ConstraintLayout main,
      @NonNull TextInputLayout textInputLayout, @NonNull TextView textView19) {
  ...
  public static ActivityForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityForgotPasswordBinding((ConstraintLayout) rootView, backBtn, btnConfirm,
          email, main, textInputLayout, textView19);
    }
