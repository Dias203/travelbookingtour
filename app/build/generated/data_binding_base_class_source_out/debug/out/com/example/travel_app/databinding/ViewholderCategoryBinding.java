...
public final class ViewholderCategoryBinding implements ViewBinding {
  ...
  private ViewholderCategoryBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout mainLayout, @NonNull ImageView pic, @NonNull TextView title) {
  ...
  public static ViewholderCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewholderCategoryBinding((LinearLayout) rootView, mainLayout, pic, title);
    }
