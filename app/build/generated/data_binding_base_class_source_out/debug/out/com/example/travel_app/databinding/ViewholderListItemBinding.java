...
public final class ViewholderListItemBinding implements ViewBinding {
  @NonNull
  ...
  private ViewholderListItemBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ViewholderListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewholderListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.viewholder_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewholderListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewholderListItemBinding((ConstraintLayout) rootView, addressTxt, imageView3,
